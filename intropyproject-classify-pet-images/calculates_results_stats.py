...
#                                                                             
# PROGRAMMER:Ben Haj Salem,Mohamed Dhia
...
def calculates_results_stats(results_dic):
    ...
    # this function 
        ...
        n_images = len(results_dic.keys())                      #- number of images
    
        for key,value in results_dic.items():
                if value[3]==1:
                        n_dogs_img +=1                           #- number of dog images
                else : n_notdogs_img +=1                        #number of NON-dog images

                if value[2]==1:
                                n_match+=1
                                                                # - number of matches between pet & classifier labels

                if value[3]==value[4] and value[4]==1:
                        n_correct_dogs+=1                                      # - number of correctly classified dog images
                        if  value[2]==1:
                                n_correct_breed+=1               # number of correctly classified dog breeds

                elif  value[3]==value[4] and value[4]==0 :
                        n_correct_notdogs+=1                                   #- number of correctly classified NON-dog images
        ...
        pct_correct_notdogs=(n_correct_notdogs/(n_images-n_dogs_img))*100      #- percentage of correctly classified NON-dogs
